...
export default function OwnerProfile() {
  ...
  const handleKycSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setLoading(true);
      await api.post('/owner/kyc', kycData);
        ...
        <div className="bg-white rounded-xl border border-amber-200 shadow-sm overflow-hidden">
          <div className="p-6 bg-amber-50 border-b border-amber-100 flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">Please submit your details to verify your identity. This is required before you can create projects and raise funds.</p>
            </div>
          </div>
          <div className="p-6">
